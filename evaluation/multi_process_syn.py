...
import _init_paths
from eval_part_joint import parallel_eval_part
...
if __name__ == '__main__':
    ...
    #     p=Process(target=parallel_eval_part, args=(num_per_cpu*k, e_ind, test_exp, baseline_exp, choose_threshold, num_parts, test_group, problem_ins, rts_all, sub_file_name))
    #     processes.append(p)
    #     p.start()
